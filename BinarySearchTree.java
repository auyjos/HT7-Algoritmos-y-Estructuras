    ...
    public class BinarySearchTree{  
      ...
      public void insert(int data) {  
          ...
          if(root == null){  
              ...
              BinarySearchTree current = root, parent = null;  
      ...
      public BinarySearchTree minNode(BinarySearchTree root) {  
          if (root.left != null)  
      ...
      public BinarySearchTree deleteNode(BinarySearchTree node, int value) {  
          if(node == null){  
              return null;  
           }  
          else {  
              ...
              //If value is equal to node's data that is, we have found the node to be deleted  
                  ...
                  //If node to be deleted has two children node  
                      ...
                      BinarySearchTree temp = minNode(node.right);  
      ...
      public void inorderTraversal(BinarySearchTree node) {  
      ...
      public static void main(String[] args) {  
          ...
          BinarySearchTree deletedNode = null;  
